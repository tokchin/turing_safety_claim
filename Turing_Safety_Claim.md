...
| **版** | 第2版ドラフト（章立て第2版・本文第6章および第18章のみ第2版） |
| --- | --- |
| **作成日** | 2026年4月29日（初版）／ 2026年5月1日（第2版章立て・第6章・第18章反映） |
...
| 第18章 事故・インシデント対応プロセス | **第2版相当に新規執筆済**（第2版章立てで新設。詳細手順は衛星文書群へ切り出し） |
| 第0〜5章、第7〜13章、第15〜16章 旧本文 | **初版本文を残置**（後続改訂で順次第2版化） |
| 第14章（サイバーセキュリティ）、第19章（段階的社会実装）、第16章（型式指定スキーム） | **未着手**（後続改訂で新規執筆） |
| Appendix A〜D | 初版を残置 |
...
そのため、本書を読む際は、第2版章立て、第6章本文、第18章本文を「方向性の確定版」、その他の本文を「初版のまま参照する補助資料」と扱われたい。
