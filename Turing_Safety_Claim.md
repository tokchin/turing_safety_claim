...
| **版** | 第2版ドラフト（章立て第2版・本文第6章＋第15〜17・第20〜22章を第2版相当に整備） |
| --- | --- |
| **作成日** | 2026年4月29日（初版）／ 2026年5月1日（第2版章立て・第6章反映、第15〜16章新規執筆・第17・20〜22章再配置） |
...
| 第20章 安全論証を支える証拠の位置づけ | **初版本文を第20章として再配置**（旧第14章の内容を踏襲。後続改訂で増補） |
| 第21章 残存リスクと今後の更新 | **初版本文を第21章として再配置**（旧第16章の内容を踏襲。後続改訂で増補） |
| 第22章 結論 | **初版本文を第22章として再配置**（旧第17章の内容を踏襲） |
| 第0〜5章、第7〜13章 旧本文 | **初版本文を残置**（後続改訂で順次第2版化） |
| 第14章（サイバーセキュリティ）、第18章（事故対応）、第19章（段階的社会実装） | **未着手**（後続改訂で新規執筆。本改訂では章タイトルとプレースホルダのみ配置） |
| Appendix A〜D | 初版を残置 |
...
そのため、本書を読む際は、第2版章立て、第6章本文、第15〜17章本文、第20〜22章本文を「方向性の確定版」、その他の本文を「初版のまま参照する補助資料」と扱われたい。
...
本活動の成果は、安全論証の更新としてフィードバックされる(第20章および第21章参照)。
...
| 共通環境曝露（雨・霧・夜間・逆光）| フロントガラス越し共通曝露 | 残存リスクとして第21章で扱う |
...
サイバーセキュリティの基本姿勢、Cybersecurity Caseの位置づけ、UN-R 155 / ISO/SAE 21434との接続については、暫定的に第6.8節および第6.9節で整理している。実体としてのCybersecurity Caseは、本書ではなく衛星文書「Cybersecurity Case」が担う。
...
UN-R 155（サイバーセキュリティ）：CSMS（Cyber Security Management System）認証、および型式におけるサイバーセキュリティ適合を要求する。本書は、第14章（後続改訂）および衛星文書「Cybersecurity Case」でCSMSとの接続を整理する。
